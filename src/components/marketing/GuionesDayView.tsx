...
export function GuionesDayView({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 lg:gap-5 min-h-[520px]">
      <aside className="lg:w-[300px] xl:w-[320px] shrink-0 flex flex-col rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden max-h-[70vh] lg:max-h-[calc(100vh-12rem)]">
