    ...
    return (
        <>
            ...
            >
                ...
                {/* Lista de Navegación */}
                <nav className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden overscroll-contain py-6 px-3 space-y-1 [-webkit-overflow-scrolling:touch]">
                    {!isCollapsed && (
