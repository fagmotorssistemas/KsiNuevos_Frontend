            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <p className="text-sm text-slate-500 bg-slate-50 p-3 rounded-lg">
                        Configura este servicio una sola vez. Cada mes, el sistema te recordará realizar el pago.
                    </p>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            placeholder="Ej: Empresa Eléctrica, Internet, Arriendo..."
                            value={nombre}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="text-xs font-bold text-slate-500 uppercase block mb-1">Costo Promedio ($)</label>
                            <input 
                                required
                                type="number" 
                                step="0.01"
