...
interface PagosDateTabsProps {
    current: DateRangePreset;
    onChange: (preset: DateRangePreset) => void;
}

export function PagosDateTabs({ current, onChange }: PagosDateTabsProps) {
    ...
    const presets: { id: DateRangePreset; label: string; icon: any }[] = [
        ...
        { id: 'LAST_WEEK', label: 'Semana Pasada', icon: ArrowLeft }, // Nueva opción
