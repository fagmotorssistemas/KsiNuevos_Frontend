...
export const VEHICLE_DOCUMENT_CATALOG: DocCatalogEntry[] = [
  ...
  { docType: 'prenda_industrial', label: 'Prenda industrial', category: 'legal', requiresFile: false, defaultStatus: 'pendiente' },
  ...
  { docType: 'procesos_legales', label: 'Procesos legales', category: 'legal', requiresFile: false, defaultStatus: 'pendiente' },
]
