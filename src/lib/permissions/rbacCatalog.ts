...
export const RBAC_SUBMODULE_DEFINITIONS: readonly RbacSubmoduleDef[] = [
  ...
  { moduleSlug: 'finanzas', slug: 'mensajes-cartera', name: 'Mensajes de cartera', sortOrder: 3, routePrefixes: ['/mensajes-cartera'] },
  { moduleSlug: 'finanzas', slug: 'cuotas-pb', name: 'Cuotas (PB)', sortOrder: 4 },
  { moduleSlug: 'finanzas', slug: 'contratos-pb', name: 'Contratos (PB)', sortOrder: 5, routePrefixes: ['/contracts'] },
  ...
  { moduleSlug: 'finanzas', slug: 'inventario-finanzas', name: 'Inventario (contable)', sortOrder: 15, routePrefixes: ['/inventario'] },
  ...
  { moduleSlug: 'marketing', slug: 'video-automation', name: 'Video automation', sortOrder: 2, routePrefixes: ['/marketing/videos', '/marketing/biblioteca-clips', '/marketing/biblioteca-videos-bruto'] },
  ...
  { moduleSlug: 'marketing', slug: 'plan-videos', name: 'Plan de videos', sortOrder: 5, routePrefixes: ['/marketing/guiones', '/marketing/guiones-v2', '/marketing/planificador'] },
