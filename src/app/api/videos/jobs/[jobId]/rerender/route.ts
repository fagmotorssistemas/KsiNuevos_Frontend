...
import { applyVideoJobEditorPatch, rerunCreatomateRenderForJob } from '@/lib/videos/pipeline'
import { normalizeMusicTrimStartSec } from '@/lib/videos/clip-config'

/**
 * POST /api/videos/jobs/[jobId]/rerender
 * Body opcional:
