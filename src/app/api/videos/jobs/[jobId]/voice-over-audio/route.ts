/**
 * POST /api/videos/jobs/[jobId]/voice-over-audio
 *
 * Sube el audio de voz en off al bucket `music-tracks-v2` (admite audio).
 * El bucket `raw-videos` suele rechazar audio/mpeg (415).
 *
...
import { uploadJobVoiceOverAudioToMusicBucket } from '@/lib/videos/storage'
