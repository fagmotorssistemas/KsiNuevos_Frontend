...
import { MusicUploader } from '@/components/videos/MusicUploader'
import { VideosPublishingSection } from '@/components/videos/VideosPublishingSection'
...
export default function VideosPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/videos/music')
      .then((r) => r.json())
      .then((data: { tracks: MusicTrack[] }) => setTracks(data.tracks ?? []))
  }, [])
    ...
    <div className="space-y-8">
      ...
      {showMusicPanel && (
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          ...
          <MusicUploader
            tracks={tracks}
            onTrackAdded={(track) => setTracks((prev) => [track as MusicTrack, ...prev])}
