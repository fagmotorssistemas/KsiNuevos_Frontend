-- Tablero leads + filtro temperatura: paginación y filas en UNA consulta (escalable).
-- Índice para ordenar por updated_at tras filtrar por temperatura.
...
COMMENT ON FUNCTION public.fetch_leads_board_temperature_page IS
  'Listado paginado del tablero con filtro de temperatura: total, respondidos y hasta p_limit filas con relaciones, sin volcar IDs al cliente.';
